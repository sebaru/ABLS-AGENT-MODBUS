...
/* Projet Abls-Habitat version 4.7       Gestion d'habitat                                      ven 13 jui 2007 16:14:03 CEST */
...
#ifndef _ABLS_AGENT_MODBUS_H_
 #define _ABLS_AGENT_MODBUS_H_
...
/************************************************** Gestion des modbus ********************************************************/
 struct MODBUS_VARS
  { gboolean started;                                                                                      /* Est-il actif ?? */
    ...
    guint16 transaction_id;
    gint nbr_entree_ana;                                                    /* Nombre de entree analogique donnée par le wago */
    gint nbr_sortie_ana;                                                    /* Nombre de sortie analogique donnée par le wago */
